...
namespace Core.Services.Products
{
    ...
    public class CreateProductService : ICreateProductService
    {
        ...
        public Product Create(Guid id, string name, string description, string brandName, string categoryName, string sku, bool isActive)
        {
            var product = _productFactory.Create(id);
            _updateProductService.Update(product, name, description, brandName, categoryName, sku, isActive);
